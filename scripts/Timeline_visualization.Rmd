...
ggplot(data, aes(xmin = start, xmax = end, ymin = value - 0.03, ymax = value + 0.03, fill = measure, color = cohort)) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 10),
        ...
        legend.text = element_text(size = 12)) +
  labs(x = "Period", y = "Assessment", fill = "", color = "Cohort") +
  geom_vline(xintercept = as.Date("2020-03-01"), linetype = "dashed", size = 0.5, color = "black") +
  annotate("text", x = as.Date("2018-07-01"), y = 1.55, label = "ELSA Brazil", size = 4, color = "black") +
  annotate("text", x = as.Date("2018-07-01"), y = 1.2, label = "ELSA UK", size = 4, color = "black") +
  annotate("text", x = as.Date("2020-06-01"), y = 1.7, label = "COVID-19", size = 3, color = "black")
